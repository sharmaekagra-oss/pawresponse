  ...
  return (
    <div className="mx-auto max-w-2xl animate-fade-in-up px-6 py-10">
      <h1 className="mb-1 text-2xl font-bold text-slate-900">
        Hi {profile.full_name.split(" ")[0] || "there"} <span className="inline-block hover:animate-wag">👋</span>
      </h1>
      ...
      {serviceable ? (
        <Link
          href="/requests/new"
          className="card-lift btn-press relative mb-8 flex flex-col items-center gap-2 overflow-hidden rounded-xl border-2 border-red-200 bg-gradient-to-b from-red-50 to-pink-50 px-6 py-10 text-center hover:border-red-300"
        >
      ...
      <div className="grid grid-cols-2 gap-4">
        <Link
          href="/pets"
          className="card-lift rounded-lg border border-slate-200 bg-white px-4 py-5 text-center shadow-sm hover:border-pink-300"
        >
